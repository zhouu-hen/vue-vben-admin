...
<script lang="ts">
  ...
  import { getPlaceList, deletePlaceById } from '/@/api/place';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function handleCreate() {
        placeModalRef.value?.initPlaceModal();
      }
      ...
      async function handleDelete(record: Recordable) {
        await deletePlaceById({ id: record.id });
        createMessage.success(`删除场地成功${record.name}`);
        handleSuccess()
      }
